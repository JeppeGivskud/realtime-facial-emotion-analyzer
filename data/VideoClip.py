...
import os
print("Starting")
print("Video file exists:", os.path.exists('/realtime-facial-emotion-analyzer/data/jeppe.mp4'))
print("Video file exists:", os.path.exists('data/jeppe.mp4'))
...
emotion_recognizer.emotion_analysis_video(
    video_path='/realtime-facial-emotion-analyzer/data/jeppe.mp4',
